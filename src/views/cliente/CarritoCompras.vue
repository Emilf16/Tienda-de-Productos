                ...
                <v-card-title>
                    ...
                    <div class="ml-4" style="position: relative;">
                        <div class="d-flex justify-space-between align-center">
                            <span
                                style="position: absolute; left: 0; top: -25px; bottom: 5; margin-left: 2%; margin-bottom: 10px; width: 20%;">Producto</span>
                            <span
                                style="position: absolute; left: 0; top: -25px; bottom: 5; margin-bottom: 10px; width: 55%; text-align: right; padding-right: -30%;">Precio</span>
                            <span
                                style="position: absolute; left: 0; top: -25px; bottom: 5; margin-bottom: 10px; width: 72%; text-align: right; padding-right: -30%;">Cantidad</span>
                            <span
                                style="position: absolute; left: 0; top: -25px; bottom: 5; margin-bottom: 10px; width: 85%; text-align: right; padding-right: -30%;">Total</span>
                        </div>
                        <hr class="mt-5"
                            style="position: relative; bottom: -9px; left: 0; right: 0; border-top: 1px solid grey;">
                    </div>
                                ...
                                <v-col>
                                    ...
                                    <v-card-text>
                                        <v-row class="mx-0 my-4">
                                            <div
                                                style="position: absolute; left: 0; top: 47px; bottom: 3; margin-bottom: 7px; width: 53%; text-align: right; padding-right: -30%;">
                                                <span style="font-size: large;" class="text-black">$ {{ producto.precio
                                                }}</span>
                                            </div>
                                            <div
                                                style="position: absolute; left: 0; top: 47px; bottom: 3; margin-bottom: 1px; width: 66%; text-align: right; padding-right: -30%;">
                                                <span style="font-size: large;" class="text-black mt-1">{{ producto.count
                                                }}</span>
                                            </div>

                                            <div
                                                style="position: absolute; left: 0; top: 32px; bottom: 5; margin-bottom: 10px; width: 100%; text-align: right; padding-right: -30%;">
                                                <v-btn @click="removeItem(index)" icon elevation="0" hover-size="0">
                                                    <v-icon left color="#252525">mdi-delete</v-icon>
                                                </v-btn>
                                            </div>
                                            <div
                                                style="position: absolute; left: 0; top: 32px; bottom: 5; margin-bottom: 10px; width: 95%; text-align: right; padding-right: -30%;">
                        ...
                        <div class="card" style="font-family:'Poppins', sans-serif; height: 260px; width: 350px;">
                            ...
                            <div class="card-details mt-6">
                                ...
                                <input type="text" placeholder="0000 0000 0000 0000" data-slots="0" data-accept="\d"
                                    size="19" style="padding-left: 5px; margin-left: 3%;" maxlength="16">
                            ...
                            <div class="exp-cvv">
                                <div class="card-details mt-4">
                                    ...
                                    <input type="text" placeholder="MM/YYYY" data-slots="my" size="5" maxlength="3"
                                ...
                                <div class="card-details mt-4">
                                    ...
                                    <input type="text" placeholder="000" data-slots="my" data-accept="\d" size="7"
                                        style="padding-left: 5px; margin-left: 13%;" maxlength="3">
