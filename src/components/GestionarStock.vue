<template>
    <v-container fluid>
        ...
        <v-row>
            <v-col v-for="(producto, index) in products" v-bind:key="index" v-bind:producto="producto" class="pa-0 mb-3"
                ...
                <v-card color="#ffffff" theme="light" elevation="4">
                    ...
                    <v-card-title class="text-h5"> {{ producto.strCategory }}</v-card-title>

                    <v-card-text class="text-h5"> ${{ producto.precio }}</v-card-text>

                    <v-card-actions>
                        <!-- funciones agregar-eliminar-ver -->
                        <v-btn color="#BE1D1D" variant="flat" text @click="elimiarProducto(index)">
                            <span style="color:white">
                                Eliminar
                            </span>
                        </v-btn>
                        <v-btn color="#008F39" variant="flat" text @click="editProduct(producto)">
                            <span style="color:white">
                                Actualizar
                            </span>
                        </v-btn>
                        <v-btn color="#0a497b" variant="flat" text @click="addProduct(producto)">
                            <span style="color:white">
                                ver
                            </span>
                        </v-btn>
